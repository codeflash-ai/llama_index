...
class SQLStructStoreQueryEngine(BaseQueryEngine):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Avoid repeated call to callback_manager_from_settings_or_context
        cb_manager = callback_manager_from_settings_or_context(Settings, index.service_context)
        super().__init__(callback_manager=cb_manager)
    ...
    def _query(self, query_bundle: QueryBundle) -> Response:
        ...
        # Inline logic to reduce function call overhead for single-use private function
        if self._sql_only:
            metadata = {}
    ...
    async def _aquery(self, query_bundle: QueryBundle) -> Response:
        # _query is synchronous, but is the fastest way to comply with current compatibility
        # This avoids unnecessary await machinery if performance is critical.
