...
class HitRate(BaseRetrievalMetric):
    ...
    def compute(
        ...
        **kwargs: Any,
        ...
        # Optimize membership lookup by converting expected_ids to a set if it's not empty
        # This significantly speeds up repeated containment checks
        if expected_ids:
            expected_id_set = set(expected_ids)
            is_hit = any(id in expected_id_set for id in retrieved_ids)
        else:
            is_hit = False
